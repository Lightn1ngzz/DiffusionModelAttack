...
parser.add_argument('--images_root', default=r"/root/autodl-tmp/test_demo/images", type=str,
                    help='The clean images root directory')
parser.add_argument('--label_path', default=r"/root/autodl-tmp/test_demo/labels.txt", type=str,
...
if __name__ == "__main__":
    ...
    with open(label_path, "r") as f:
        ...
        for i in f.readlines():
            label.append(int(i.rstrip()))  # The label number of the imagenet-compatible dataset starts from 1.
